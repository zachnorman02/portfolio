...
\begin{document}
    ...
    \section{Projects}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Enhanced the website for Generate, a student-led product development organization at Northeastern University, by implementing mobile responsiveness and fixing styling issues to improve user experience across devices.
                \item Tools Used: React
            \end{highlights}
        \end{onecolentry}
        \vspace{0.2 cm}
        \begin{twocolentry}{
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Tools Used: HTML, Javascript, WebGL
            \end{highlights}
        \end{onecolentry}
        \vspace{0.2 cm}
