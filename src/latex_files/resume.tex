...
\begin{document}
    ...
    \begin{twocolentry}{
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Maintain a Python-based Discord bot with slash-command admin automation, including role and member management, content moderation, and automated server and admin tasks.
            \end{highlights}
        \end{onecolentry}
        \vspace{0.12 cm}
        \begin{twocolentry}{
