...
\begin{document}
    ...
    \begin{onecolentry}
      \begin{highlights}
        ...
        \item Build Tableau reports for hedged share classes to improve daily reporting for fixed income clients, reducing reliance on manual report creating and external files.
