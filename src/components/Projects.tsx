    ...
    <div className="content">
      ...
      >
        ...
        <div className="project">
          ...
          <p>
            Covey.town is a video conferencing site similar to Gather.town,
            where there are various areas for users to video chat and interact
            in. We added a new type of area to existing Covey.town codebase that
            allowed for the creation of polls tied to the area. Our development
            allowed for binary (yes/no) polls to be created and voted on,
            utilizing the react-leaf-polls package. Typescript and React were
            used for implementation, and tests were written using Jest. Our
            feature was deployed using Heroku and Netlify. Future development
            would include fixing the issue with closing the polling window,
            relaying votes to other players, and showing the results at the end
            of a polling time window.
          </p>
        </div>
        <div className="project">
          ...
          <p>
            ...
            most accurate, and then found the best features, which was time
            left, armor of each team, and amount of money of each team.
            Scikit-learn was used for the feature selection and models, and
        ...
        <div className="project">
          ...
          <p>
            Created an image processor using Java Swing. Allowed for importing
            and exporting of images, and had various filter options that could
        ...
        <div className="project">
          ...
          <p>
            Given data on universities and their racial breakdown on their
            campus, we wanted to see if there was a relationship between various
            ...
            public or private, their total price, and amount of student
            population in lower income brackets influenced the racial diversity.
            Pandas and Numpy were used for data wrangling, Scikit-learn was used
            for feature selection and classification models, and Plotly and
            Seaborn were used for visualization.
          </p>
        </div>
      </Carousel>
    </div>
